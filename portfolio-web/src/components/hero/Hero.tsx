  ...
  "
    >
      <motion.div
        ...
        "
      >
        <p className="text-[3rem] text-color3 custom:text-[3.4375rem]">
          {heroData.greeting}
        </p>
        ...
        >
          <span
            className="
              ...
              group-hover:opacity-100 group-hover:translate-y-[-3rem] group-hover:px-3
              p-2.5 rounded-md bg-[#090909] shadow-lg border border-white/10
            "
          >
            <span className="bg-clip-text text-transparent bg-gray-600 group-hover:text-[1.1rem]">
              <p className="text-[#a3a3a3]">Resume</p>
            </span>
          </span>
          <FaFolder className="w-20 text-[3rem] text-[#6d6d6d] transition-all duration-300 cursor-pointer group-hover:translate-y-[-5px] z-10" />
